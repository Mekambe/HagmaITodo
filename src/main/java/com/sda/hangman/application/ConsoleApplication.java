...
import com.sda.hangman.infrastructure.memory.file.FileBasedForbiddenWordsRepository;
...
private PhraseService phraseService;
    ...
    public ConsoleApplication() throws FileNotFoundException {
        ...
        ForbiddenWordsValidator forbiddenWordsValidator = new ForbiddenWordsValidator
                (new FileBasedForbiddenWordsRepository(new File("C:\\Users\\RENT\\Desktop\\Git\\javapoz11-programowanie-kopiaszymona\\src\\main\\resources\\hangman\\forbiddenWords.txt")));
    ...
    private void addPhrase() {
      String phrase = consoleViews.addPhraseMessage();
        try {
            ...
            consoleViews.displayPhraseAddedSuccessfuly(phrase);
